...
import { chapterTitlesFetch } from '../actions';;
...
class NovelScreen extends Component {
  ...
  componentWillMount() {
    ...
    this.props.chapterTitlesFetch({ id:_id });
  ...
  createDataSource({chapters}) {
    ...
    this.dataSource = ds.cloneWithRows(chapters);
  }
...
export default connect(mapStateToProps, { chapterTitlesFetch })(NovelScreen);
